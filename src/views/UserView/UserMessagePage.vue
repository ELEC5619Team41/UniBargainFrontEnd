        ...
        <div class="rightSection">
            ...
            <div class="chatFooter">
                ...
                <div style="display: flex; background-color: rgb(222, 222, 222);">
                    ...
                    <!-- <div v-if="this.showEmoji" style="background-color:white; position: absolute; margin-top: -200px; margin-left: 50px; width:280px; height:320px;">

                    </div> -->
                    <EmojiPicker v-if="this.showEmoji" :hide-group-icons="true" :hide-search="true" :native="true" @select="onSelectEmoji"
                            style="position: absolute; margin-top: -5px; margin-left: 50px; " />
                    ...
                    <el-icon size="30px" style="margin-left: 30px;" @click="sendAddress">
                        <Location />
                    </el-icon>
...
export default {
    ...
    methods: {
        ...
        async dateSelect() {
            if (this.calendarOptions.events.url == null) {
                alert('Please add your timetable first');
                return;
            }
        ...
        sendAddress() {
            ...
            this.chatInput += this.deliveryAddress
        },
        async getTimetable() {
